...
class ContaCorrente(Conta):
  ...
  def sacar(self, valor):
    ...
    if excedeu_limite:
      print("\n&&& Operação cancelada! Valor excede o limite! &&&")

    elif excedeu_saques:
      print("\n&&& Operação cancelada! Número de saques excede o limite! &&&")
    else:
...
def exibir_extrato(clientes):
  ...
  extrato = ""
  if not transacoes:
    extrato = "Não existem movimentações nessa conta"
  else:
...
def criar_cliente(clientes):
  ...
  endereco = input("Informe o endereço do cliente(logradouro, numero, bairro, cidade/uf):" )
